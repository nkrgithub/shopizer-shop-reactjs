...
const Checkout = ({
  ...
  const setDefaultsValue = () => {
    if (currentLocation.length > 0) {
      ...
      setValue(
        "city",
        currentLocation.find((i) => i.types.some((i) => i === "locality"))
          .address_components[0].short_name,
      );
      setValue(
        "stateProvince",
  ...
  const onChangeShipping = async () => {
    ...
    if (isShipping) {
      param = {
        postalCode: watch("shipPostalCode"),
        countryCode: watch("shipCountry"),
      };
    } else {
      param = {
    ...
    try {
      ...
      if (response) {
        if (
          response.shippingOptions === "null" ||
          response.shippingOptions === null
        ) {
          shippingQuoteChange("");
        } else {
          shippingQuoteChange(
            response.shippingOptions[response.shippingOptions.length - 1]
  ...
  const onPayment = async () => {
    ...
    let param = {};
    action =
      constant.ACTION.AUTH + constant.ACTION.CART + cartID + "/" + "paytmCode";
    param = {
    ...
    try {
      ...
      var action_src =
        "https://securegw-stage.paytm.in/theia/api/v1/showPaymentPage?mid=LHMWXe52738162569788&orderId=" +
        response.order;
      var your_form = document.getElementById("your_form");
      ...
      if (isAccount) {
        ...
        addToast("Your order submission has been failed", {
          appearance: "error",
          autoDismiss: true,
        });
      }
  ...
  const onAgreement = async () => {
    let action =
      ...
      constant.ACTION.BOXES +
      constant.ACTION.AGREEMENT;
    try {
      let response = await WebService.get(action);
      if (response) {
  ...
  function changeAddress() {
    var param = {
      postalCode: watch("postalCode"),
      countryCode: watch("country"),
      zoneCode: watch("stateProvince"),
    };
    if (isShipping) {
      param = {
        postalCode: watch("shipPostalCode"),
        countryCode: watch("shipCountry"),
        zoneCode: watch("shipStateProvince"),
      };
    }
      ...
      >
        ...
        <div className="checkout-area pt-95 pb-100">
          <div className="container">
            {isValidObject(cartItems) &&
              cartItems.products.length > 0 &&
              !userData && (
                <div className="checkout-heading">
                  <Link to={"/login"}>
                    {strings["Returning customer ? Click here to login"]}
                  </Link>
                </div>
              )}
                ...
                <div className="row">
                          ...
                          <div className="billing-select mb-20">
                            ...
                            {stateData && stateData.length > 0 ? (
                              ...
                              <input
                                ...
                                name={paymentForm.stateProvince.name}
                                ref={register(
                                  paymentForm.stateProvince.validate,
                                )}
                              />
                            )}
                      ...
                      {isAccount && (
                        <div>
                          <p className="main-color">
                            ...
                            below.If you are a returning customer please login
                          ...
                          <div className="col-lg-12">
                            <div className="billing-info mb-20">
                              ...
                              <input
                                ...
                                ref={register(
                                  paymentForm.repeatPassword.validate,
                                )}
                            ...
                            <div className="col-lg-6 col-md-6">
                              <div className="billing-info mb-20">
                                ...
                                <input
                                  ...
                                  ref={register(
                                    paymentForm.shipFirstName.validate,
                                  )}
                                />
                            ...
                            <div className="col-lg-6 col-md-6">
                              <div className="billing-info mb-20">
                                ...
                                <input
                                  ...
                                  ref={register(
                                    paymentForm.shipLastName.validate,
                                  )}
                                />
                            ...
                            <div className="col-lg-12">
                              <div className="billing-info mb-20">
                                ...
                                <input
                                  ...
                                  ref={register(
                                    paymentForm.shipCompany.validate,
                                  )}
                                />
                              </div>
                            </div>
                            ...
                            <div className="col-lg-12">
                              <div className="billing-info mb-20">
                                ...
                                <input
                                  ...
                                  ref={register(
                                    paymentForm.shipAddress.validate,
                                  )}
                                />
                            ...
                            <div className="col-lg-6 col-md-6">
                              <div className="billing-info mb-20">
                                ...
                                <input
                                  ...
                                  ref={register(
                                    paymentForm.shipPostalCode.validate,
                                  )}
                                  onChange={() => {
                                    clearTimeout(timer);
                                    setTimer(
                  ...
                  <div className="col-lg-6">
                    <div className="your-order-area">
                            ...
                            <div className="your-order-bottom">
                              {
                                <div className="shippingRow">
                                  ...
                                  <ul>
                                    ...
                                    >
                                      {" "}
                                      This option let you reserve you order
                                      items through the online system and pick
                                      up your order by yourself at the store.
                                      this option is also offered when no other
                                      shipping option is available for your
                                      region.
                                    </li>
                                  </ul>
                                </div>
                      ...
                      {window._env_.APP_PAYMENT_TYPE_STRIPE === "STRIPE" && (
                      ...
                      {window._env_.APP_PAYMENT_TYPE_PAYTM === "PAYTM" && (
                        <div className="payment-method mt-25">
                          <form
                            id="your_form"
                            name="paytm"
